...
def main_root_content() -> str:
    ...
    return ("<h1>CEP Main</h1>\n"
            ...
            "<b>/search_csv/[CEP]</b> search CEP only in keeped list "
            "and show in CSV format<br>\n"
            "<b>/search_html/[CEP]</b> search CEP only in keeped list "
            "and show in HTML format<br>\n" )
